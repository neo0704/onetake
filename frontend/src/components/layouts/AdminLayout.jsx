    ...
    <div className="flex h-screen bg-[#0f0f1a] overflow-hidden">
      ...
      <aside
        ...
        <div
          ...
          <button onClick={() => setShowChangePw(true)} title={!expanded ? 'Change Password' : undefined}
            className={`btn-ghost w-full mt-2 text-sm ${!expanded ? 'lg:justify-center' : ''}`}>
            <KeyRound className="w-4 h-4 flex-shrink-0" /> <span className={!expanded ? 'lg:hidden' : ''}>Change Password</span>
          </button>
